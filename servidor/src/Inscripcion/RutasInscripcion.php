...
function registrarRutasInscripcion(AltoRouter $router, callable $mapAuthenticated): void
{
  ...
  $mapAuthenticated('GET', '/inscripciones/resumen', [$controlador, 'listarResumenInscripciones']);
  ...
  $mapAuthenticated('PATCH', '/inscripciones/[i:id]/retiro', [$controlador, 'retirarInscripcion']);
}
