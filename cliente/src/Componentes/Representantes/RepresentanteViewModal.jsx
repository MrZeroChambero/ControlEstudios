...
export const RepresentanteViewModal = ({ isOpen, onClose, representante }) => {
  ...
  return (
    <div className={representantesViewModalClasses.overlay}>
      <div className={representantesViewModalClasses.content}>
        <div className={representantesViewModalClasses.header}>
          <h2 className={representantesViewModalClasses.title}>
            Detalle de Representante
          </h2>
          <button
            onClick={onClose}
            type="button"
            className={representantesViewModalClasses.closeButton}
            aria-label="Cerrar"
          >
            ✕
          </button>
        ...
        <div className={representantesViewModalClasses.body}>
          ...
          <Section title="Datos del representante">
            ...
            <Field
              label="Oficio"
              value={
                representante.oficio || representante.representante?.oficio
              }
            />
            <Field
          ...
          {representante.personal && (
            <Section title="Personal asociado">
              <Field
                label="Cargo"
                value={representante.personal.nombre_cargo}
              />
              <Field
                label="Función"
        ...
        <div className={representantesViewModalClasses.footer}>
          <button
            onClick={onClose}
            type="button"
